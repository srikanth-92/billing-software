...
const styles = StyleSheet.create({
  ...
  headerSub: { fontSize: 12, color: '#fed7aa', marginTop: 2 },
  headerRight: { flexDirection: 'row', alignItems: 'center', gap: 10 },
  salesBtn: { backgroundColor: 'rgba(255,255,255,0.2)', paddingHorizontal: 12, paddingVertical: 7, borderRadius: 8 },
  salesBtnText: { color: '#fff', fontSize: 13, fontWeight: '600' },
  ...
  itemPrice: { fontSize: 14, fontWeight: 'bold', color: '#1e293b', marginRight: 12, minWidth: 52, textAlign: 'right' },
  qtyRow: { flexDirection: 'row', alignItems: 'center' },
  qtyBtn: { backgroundColor: '#f97316', width: 30, height: 30, borderRadius: 8, justifyContent: 'center', alignItems: 'center' },
  qtyBtnDisabled: { backgroundColor: '#e2e8f0' },
  ...
  emptyMenu: { padding: 20, color: '#94a3b8', textAlign: 'center', fontSize: 14 },
  ...
  cartItemsText: { color: '#94a3b8', fontSize: 12 },
  cartTotal: { color: '#fff', fontSize: 18, fontWeight: 'bold' },
  checkoutBtn: { backgroundColor: '#f97316', paddingHorizontal: 20, paddingVertical: 12, borderRadius: 10 },
  ...
  tabletCart: {
    width: 320, backgroundColor: '#fff', borderLeftWidth: 1, borderLeftColor: '#e2e8f0',
    paddingHorizontal: 20, paddingTop: 20, paddingBottom: 24, flexDirection: 'column',
  },
  cartPanelTitle: { fontSize: 20, fontWeight: 'bold', color: '#1e293b', marginBottom: 16 },
  ...
  cartItemSub: { fontSize: 12, color: '#64748b', marginTop: 2 },
  cartItemTotal: { fontSize: 14, fontWeight: 'bold', color: '#1e293b' },
  cartDivider: { height: 1, backgroundColor: '#e2e8f0', marginVertical: 14 },
  cartTotals: { marginBottom: 16 },
  totalLine: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 6 },
  totalLineLabel: { fontSize: 14, color: '#64748b' },
  totalLineValue: { fontSize: 14, color: '#64748b' },
  grandTotalLine: { marginTop: 6, paddingTop: 10, borderTopWidth: 1, borderTopColor: '#e2e8f0' },
  grandTotalLabel: { fontSize: 18, fontWeight: 'bold', color: '#1e293b' },
  grandTotalValue: { fontSize: 18, fontWeight: 'bold', color: '#f97316' },
  cartActions: { flexDirection: 'row', gap: 10 },
  clearBtn: { borderWidth: 1.5, borderColor: '#e2e8f0', borderRadius: 10, paddingVertical: 14, paddingHorizontal: 16, alignItems: 'center' },
  clearBtnText: { color: '#64748b', fontWeight: '600', fontSize: 14 },
  checkoutBtnTablet: { flex: 1, backgroundColor: '#f97316', borderRadius: 10, paddingVertical: 14, alignItems: 'center' },
  checkoutBtnDisabled: { backgroundColor: '#fdba74' },
